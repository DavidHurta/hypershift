...
func hyperShiftOperatorManifests(opts Options) ([]crclient.Object, error) {
	...
	operatorClusterRole := assets.HyperShiftOperatorClusterRole{}.Build(opts.EnableCVOManagementClusterMetricsAccess)
	...
	operatorDeployment := assets.HyperShiftOperatorDeployment{
		...
		CVOManagementClusterMetricsAccess: opts.EnableCVOManagementClusterMetricsAccess,
	}.Build()
